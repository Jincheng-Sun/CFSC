...
from keras.layers import BatchNormalization, Conv2D, Dense, Activation, LeakyReLU, Flatten, Dropout, MaxPool2D, GlobalAveragePooling2D
...
def addLayers(model,filter,starterL):
    if(starterL):
